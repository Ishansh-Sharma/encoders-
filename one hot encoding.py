...
#favourable_col2 = lung_database2.select_dtypes(include='object')
#encodable_col = [col for col in favourable_col2.columns if lung_database2[col].nunique() <= 10]
#print(encodable_col)
...
new = onehotencoder_custom(lungs_condition2)
print(new)
